...
tf.app.flags.DEFINE_string(
    'data_dir',
    '/home/usmann/Development/derendering/data/',
...
def trainer(model_params):
    ...
    reset_graph()
    model = derender_model.Model(model_params)
